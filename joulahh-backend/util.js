...
export const isAuth = (req, res, next) => {
    ...
    if(authorization){
        ...
        jwt.verify(token, process.env.JWT_SECRET || 'somethingsecret',(error, decode)=>{ //un data'ee ke hamrahe token mifresti to bakhshe dorost kardane token (jwt.sign), jwt.verigy return mikone oon data ro tooye decode.
            if(error){
